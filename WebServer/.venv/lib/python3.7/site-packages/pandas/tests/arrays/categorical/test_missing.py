...
class TestCategoricalMissing:
    ...
    def test_fillna_iterable_category(self, named):
        ...
        if named:
            entities.Point = collections.namedtuple("entities.Point", "x y")
        else:
            entities.Point = lambda *args: args  # tuple
        cat = Categorical(np.array([entities.Point(0, 0), entities.Point(0, 1), None], dtype=object))
        result = cat.fillna(entities.Point(0, 0))
        expected = Categorical([entities.Point(0, 0), entities.Point(0, 1), entities.Point(0, 0)])
